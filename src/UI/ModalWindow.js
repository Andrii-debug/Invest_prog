      ...
      <div className={styles["wrapper"]}>
        <div className={styles["contentBlock"]}>
          ...
          <form className={styles["form_block"]} onSubmit={onSubmitHandler}>
            ...
            <div className={styles["amount_available"]}>
              Amount available: ${available}
            </div>

            <div className={styles["loan_ends"]}>
              Loan ends in: {props.remaining.month} month {props.remaining.day}{" "}
              days
            </div>

            <label htmlFor="1" className={styles["investment_text"]}>
              Investment amount
            </label>
            ...
            <input
              ...
              min="0"
              type="number"
              className={styles["input_investment"]}
              onChange={onHandlerInput}
            />

            <button
              type="submit"
              className={styles["accept_invest_btn"]}
              onClick={calculateAvailable}
            >
