...
function TotalAmount(props) {
    ...
    const invested = props.loans.reduce(
    (accumulator, loan) => accumulator + parseFloat(loan.amount),
    0
  );
  ...
  return (
    <React.Fragment>
      ...
      <p className={styles["total_amount_text"]}>
        ${parseFloat(total) + parseFloat(props.total)}
